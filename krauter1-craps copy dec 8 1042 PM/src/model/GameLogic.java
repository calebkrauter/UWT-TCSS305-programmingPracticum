...
//    private CrapsController crapsController;
    ...
    private int myRandomRoll1 = 0;
    private int myRandomRoll2 = 0;
    private int mySum = 0;
...
//        setHouseWins();
////        setPlayerScore(0);
        setMyRandomRoll1(random.nextInt(1, 7));
        setMyRandomRoll2(random.nextInt(1, 7));
    }
...
//                mySum, myPlayerWins, myHouseWins, myPlayerScore);
    ...
    private void setMyRandomRoll1(int theValue) {
        myRandomRoll1 = theValue;
    }

    private void setMyRandomRoll2(int theValue) {
        myRandomRoll2 = theValue;
    }
